...
class PolymorphicPromptAssembler:
    ...
    In DoublePromptAssemble, the assembled prompt is split into:
    ...
    In SinglePromptAssemble, the single assembled prompt contains both the constraints and user input.
    ...
    def SinglePromptAssemble(self, user_input: str = None):
        """
    ...
    def DoublePromptAssemble(self, user_input: str = None):
        """
